  ...
  return (
    <div className="flex flex-col min-h-screen bg-white dark:bg-gray-800">
      ...
      <div className="flex flex-col lg:flex-row">
        <Sidebar />
        <div className="flex-1 container mx-auto mt-6 mb-28 px-4">
          <div className="bg-slate-100 shadow-lg rounded-lg overflow-hidden dark:bg-gray-700 dark:text-white">
