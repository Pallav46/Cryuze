          ...
          <div className="flex justify-between items-center gap-4">
            ...
            <div className="relative cursor-pointer group">
              ...
              {authUser ? (
                ...
                <Link to="/login">
                  <button className="absolute inline-flex items-center justify-center mb-0 me-0 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-black to-black group-hover:from-black-600 group-hover:to-black-500 hover:text-white dark:text-black focus:ring-2 focus:outline-none dark:focus:ring-zinc-800">
